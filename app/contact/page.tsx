...
const Contact = () => {
	...
	return (
		<div className="pl-3 pr-3">
			<Link href="https://discord.com/users/845674119391477820" className="flex flex-col items-center my-5">
			...
			<Link href="https://github.com/tamton-aquib" className="flex flex-col items-center my-5">
			...
			<Link href="https://x.com/tamton_aquib" className="flex flex-col items-center my-5">
			...
			<Link href="https://dev.to/tamtonaquib" className="flex flex-col items-center my-5">
